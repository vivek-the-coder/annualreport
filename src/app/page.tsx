...
function HeroPreview() {
  ...
  return (
    <div className="animate-fade-up delay-150 relative mx-auto w-full max-w-[520px]">
      <div className="absolute -inset-6 -z-10 rounded-[32px] bg-gradient-to-br from-navy-100 via-white to-gold-100 opacity-70 blur-2xl" aria-hidden />
      <div className="card overflow-hidden !rounded-2xl">
        <div className="flex items-center justify-between border-b border-slate-100 bg-navy-900 px-5 py-3.5">
          <div className="flex items-center gap-2">
            <span className="h-2.5 w-2.5 rounded-full bg-white/20" aria-hidden />
            <span className="h-2.5 w-2.5 rounded-full bg-white/20" aria-hidden />
            <span className="h-2.5 w-2.5 rounded-full bg-white/20" aria-hidden />
          </div>
          <p className="text-xs font-semibold text-white/80">Annual Report 2025–26 · Live Progress</p>
        </div>
      ...
      <div className="card animate-fade-up delay-300 absolute -left-4 -bottom-6 hidden items-center gap-3 !rounded-xl px-4 py-3 shadow-lg sm:flex">
      ...
      <main id="main">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-14 px-4 pb-20 pt-16 sm:px-6 lg:grid-cols-2 lg:pt-24">
            <div className="animate-fade-up">
              <p className="inline-flex items-center gap-2 rounded-full border border-navy-100 bg-navy-50 px-3.5 py-1.5 text-xs font-bold text-navy-700">
                <Sparkles className="h-3.5 w-3.5" aria-hidden /> Built for colleges, universities & institutes
              </p>
              <h1 className="font-display mt-5 text-4xl font-extrabold leading-[1.08] tracking-tight text-navy-950 sm:text-5xl lg:text-[56px]">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                <Link href="/login" className={cn(btn.primary, "px-6 py-3 text-base")}>
                  Create Annual Report <ArrowRight className="h-4.5 w-4.5 h-5 w-5" aria-hidden />
                </Link>
                <Link href="/reports/2025-26" className={cn(btn.secondary, "px-6 py-3 text-base")}>
            ...
            <div className="mx-auto grid max-w-7xl grid-cols-2 gap-6 px-4 py-8 sm:px-6 md:grid-cols-4">
              {[
                ...
                <div key={s.l} className="text-center">
                  <p className="font-display text-3xl font-extrabold text-navy-900">{s.v}</p>
        ...
        <section id="how-it-works" className="mx-auto max-w-7xl px-4 py-24 sm:px-6">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="font-display mt-3 text-3xl font-extrabold tracking-tight text-navy-950 sm:text-4xl">
          ...
          <div className="relative mt-14 grid gap-8 md:grid-cols-4">
            ...
            {STEPS.map((s, i) => (
              <div key={s.num} className="animate-fade-up relative text-center" style={{ animationDelay: `${i * 100}ms` }}>
                <div className="relative z-10 mx-auto flex h-16 w-16 items-center justify-center rounded-2xl border border-navy-100 bg-white text-navy-700 shadow-sm">
                  <s.icon className="h-7 w-7" aria-hidden />
                </div>
                <p className="mt-4 text-xs font-extrabold tracking-widest text-gold-600">{s.num}</p>
                <h3 className="font-display mt-1 text-lg font-bold text-navy-900">{s.title}</h3>
                <p className="mx-auto mt-2 max-w-[240px] text-sm leading-relaxed text-slate-500">{s.body}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        {/* Features */}
        <section id="features" className="border-y border-slate-100 bg-slate-50/60 py-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            ...
            <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {FEATURES.map((f, i) => (
                <div key={f.title} className="card card-hover animate-fade-up p-6" style={{ animationDelay: `${i * 70}ms` }}>
        ...
        {/* Analytics teaser */}
        <section id="analytics" className="mx-auto grid max-w-7xl items-center gap-12 px-4 py-24 sm:px-6 lg:grid-cols-2">
          <div>
            ...
            <Link href="/login" className={cn(btn.primary, "mt-8")}>Explore Analytics <BarChart3 className="h-4 w-4" aria-hidden /></Link>
          </div>
            ...
            <div className="mt-6 flex items-end gap-6" aria-hidden>
              {[
                ...
                <div key={b.y} className="flex flex-1 flex-col items-center gap-2">
                  <p className="font-display text-lg font-extrabold text-navy-800">{b.v}%</p>
                  ...
                  <p className="text-xs font-semibold text-slate-500">{b.y}</p>
                </div>
              ))}
            </div>
            <div className="mt-5 flex items-center gap-2 rounded-xl bg-emerald-50 px-4 py-3 text-sm font-bold text-emerald-700">
              <LineChart className="h-4 w-4" aria-hidden /> +6.8% improvement this year
            </div>
          </div>
        </section>

        {/* Archive teaser */}
        <section id="archive" className="border-t border-slate-100 bg-navy-950 py-24 text-white">
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            <div className="grid items-center gap-12 lg:grid-cols-2">
              <div>
                ...
                <Link href="/reports/2025-26" className="mt-8 inline-flex items-center gap-2 rounded-xl bg-white px-5 py-3 text-sm font-bold text-navy-900 transition hover:bg-slate-100">
        ...
        <section id="about" className="mx-auto max-w-5xl px-4 py-24 text-center sm:px-6">
          ...
          <h2 className="font-display mt-5 text-3xl font-extrabold tracking-tight text-navy-950 sm:text-4xl">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            <Link href="/login" className={cn(btn.primary, "px-6 py-3 text-base")}>Get Started Free</Link>
            <Link href="/reports/2025-26" className={cn(btn.secondary, "px-6 py-3 text-base")}>See a Published Report</Link>
          </div>
        </section>
      </main>
